...
/**
 * Message part containing text content (Doct format)
 */
 ...
 * Supports both Doct format and Claude format
 */
...
/**
 * Extract text content from message (supports both Doct and Claude formats)
 */
function extractContent(message: ChatMessageData['message']): string {
  if (!message) return '';

  // Doct format: message.parts[].text
