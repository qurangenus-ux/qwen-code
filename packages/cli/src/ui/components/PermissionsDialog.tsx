...
import { isPathWithinRoot } from '@doct-code/doct-code-core';
  ...
  return [
    {
      ...
      description: t('Checked in at .doct/settings.json'),
      value: SettingScope.Workspace,
      key: 'project',
    },
    {
      label: t('User settings'),
      description: t('Saved in at ~/.doct/settings.json'),
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("Doct Code won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('Doct Code will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('Doct Code is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
