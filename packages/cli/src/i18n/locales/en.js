...
// English translations for Doct Code CLI
...
export default {
  ...
  'for help on Doct Code': 'for help on Doct Code',
  'show version info': 'show version info',
  'submit a bug report': 'submit a bug report',
  'About Doct Code': 'About Doct Code',
  Status: 'Status',
  ...
  'Available Doct Code CLI tools:': 'Available Doct Code CLI tools:',
  ...
  // ============================================================================
  'Project Level (.doct/agents/)': 'Project Level (.doct/agents/)',
  'User Level (~/.doct/agents/)': 'User Level (~/.doct/agents/)',
  ...
  // ============================================================================
  'View and edit Doct Code settings': 'View and edit Doct Code settings',
  Settings: 'Settings',
  ...
  'Respect .doctignore': 'Respect .doctignore',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Doct Code hooks': 'Manage Doct Code hooks',
  ...
  'block processing, erase original prompt, and show stderr to user only':
    'block processing, erase original prompt, and show stderr to user only',
  'stdout shown to Doct': 'stdout shown to Doct',
  ...
  'Add MCP servers to your settings to get started.':
    'Add MCP servers to your settings to get started.',
  'Run doct --debug to see error logs': 'Run doct --debug to see error logs',
  ...
  'Doct OAuth authentication cancelled.':
    'Doct OAuth authentication cancelled.',
  'Doct OAuth Authentication': 'Doct OAuth Authentication',
  ...
  'Doct OAuth Authentication Timeout': 'Doct OAuth Authentication Timeout',
  ...
  'Saved in .doct/settings.local.json': 'Saved in .doct/settings.local.json',
  'Project settings': 'Project settings',
  'Checked in at .doct/settings.json': 'Checked in at .doct/settings.json',
  'User settings': 'User settings',
  'Saved in at ~/.doct/settings.json': 'Saved in at ~/.doct/settings.json',
  ...
  'Configure Doct authentication information with Doct-OAuth or Alibaba Cloud Coding Plan':
    'Configure Doct authentication information with Doct-OAuth or Alibaba Cloud Coding Plan',
  'Authenticate using Doct OAuth': 'Authenticate using Doct OAuth',
  ...
  '  doct auth                - Interactive authentication setup\n':
    '  doct auth                - Interactive authentication setup\n',
  '✓ Authentication Method: Doct OAuth': '✓ Authentication Method: Doct OAuth',
