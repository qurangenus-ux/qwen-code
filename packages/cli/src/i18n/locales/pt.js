...
// Portuguese translations for Doct Code CLI (pt-BR)
...
export default {
  ...
  'Analyzes the project and creates a tailored DOCT.md file.':
    'Analisa o projeto e cria um arquivo DOCT.md personalizado.',
  'List available Doct Code tools. Usage: /tools [desc]':
    'Listar ferramentas Doct Code disponíveis. Uso: /tools [desc]',
  'List available skills.': 'Listar habilidades disponíveis.',
  'Available Doct Code CLI tools:': 'Ferramentas CLI do Doct Code disponíveis:',
  ...
  'open full Doct Code documentation in your browser':
    'abrir documentação completa do Doct Code no seu navegador',
  ...
  // ============================================================================
  'Project Level (.doct/agents/)': 'Nível de Projeto (.doct/agents/)',
  'User Level (~/.doct/agents/)': 'Nível de Usuário (~/.doct/agents/)',
  ...
  'Generate with Doct Code (Recommended)': 'Gerar com Doct Code (Recomendado)',
  ...
  // ============================================================================
  'View and edit Doct Code settings': 'Ver e editar configurações do Doct Code',
  Settings: 'Configurações',
  'To see changes, Doct Code must be restarted. Press r to exit and apply changes now.':
    'Para ver as alterações, o Doct Code deve ser reiniciado. Pressione r para sair e aplicar as alterações agora.',
  ...
  'How is Doct doing this session? (optional)':
    'Como o Doct está se saindo nesta sessão? (opcional)',
  Bad: 'Ruim',
  Fine: 'Bom',
  Good: 'Ótimo',
  Dismiss: 'Ignorar',
  ...
  'Respect .doctignore': 'Respeitar .doctignore',
  ...
  'This extension will append info to your DOCT.md context using {{fileName}}':
    'Esta extensão anexará informações ao seu contexto DOCT.md usando {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Doct Code.':
    'Você está instalando uma extensão de {{originSource}}. Alguns recursos podem não funcionar perfeitamente com o Doct Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Doct Code in one of these supported IDEs: VS Code or VS Code forks.':
    'A integração com IDE não é suportada no seu ambiente atual. Para usar este recurso, execute o Doct Code em um destes IDEs suportados: VS Code ou forks do VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Doct Code hooks': 'Gerenciar hooks do Doct Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Doct Code.':
    'Este menu é somente leitura. Para adicionar ou modificar hooks, edite settings.json diretamente ou pergunte ao Doct Code.',
  ...
  'To add hooks, edit settings.json directly or ask Doct.':
    'Para adicionar hooks, edite settings.json diretamente ou pergunte ao Doct.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Doct to help.':
    'Para modificar ou remover este hook, edite settings.json diretamente ou pergunte ao Doct.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Doct Code.':
    'Para reativar os hooks, remova "disableAllHooks" do settings.json ou pergunte ao Doct Code.',
  // Hooks - Source
  Project: 'Projeto',
  User: 'Usuário',
  System: 'Sistema',
  ...
  'Right before Doct Code concludes its response':
    'Logo antes do Doct Code concluir sua resposta',
  ...
  'stdout shown to Doct': 'stdout mostrado ao Doct',
  ...
  'Generate a project summary and save it to .doct/PROJECT_SUMMARY.md':
    'Gerar um resumo do projeto e salvá-lo em .doct/PROJECT_SUMMARY.md',
  ...
  'Successfully added DOCT.md files from the following directories if there are:\n- {{directories}}':
    'Arquivos DOCT.md adicionados com sucesso dos seguintes diretórios, se houverem:\n- {{directories}}',
  ...
  'Run doct --debug to see error logs':
    'Execute doct --debug para ver os logs de erro',
  ...
  'Login with DoctChat account to use daily free quota.':
    'Faça login com sua conta DoctChat para usar a cota gratuita diária.',
  ...
  'Doct OAuth authentication timed out. Please try again.':
    'A autenticação Doct OAuth expirou. Tente novamente.',
  'Doct OAuth authentication cancelled.': 'Autenticação Doct OAuth cancelada.',
  'Doct OAuth Authentication': 'Autenticação Doct OAuth',
  ...
  'Doct OAuth Authentication Timeout':
    'Tempo Limite de Autenticação Doct OAuth',
  ...
  'Waiting for Doct OAuth authentication...':
    'Aguardando autenticação Doct OAuth...',
  'Note: Your existing API key in settings.json will not be cleared when using Doct OAuth. You can switch back to OpenAI authentication later if needed.':
    'Nota: Sua chave de API existente no settings.json não será limpa ao usar o Doct OAuth. Você pode voltar para a autenticação do OpenAI mais tarde, se necessário.',
  'Note: Your existing API key will not be cleared when using Doct OAuth.':
    'Nota: Sua chave de API existente não será limpa ao usar o Doct OAuth.',
  ...
  'Invalid DOCT_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Valor DOCT_DEFAULT_AUTH_TYPE inválido: "{{value}}". Valores válidos são: {{validValues}}',
  ...
  'Doct 3.6 Plus — efficient hybrid model with leading coding performance':
    'Doct 3.6 Plus — modelo híbrido eficiente com desempenho líder em programação',
  'The latest Doct Vision model from Alibaba Cloud ModelStudio (version: doct3-vl-plus-2025-09-23)':
    'O modelo Doct Vision mais recente do Alibaba Cloud ModelStudio (versão: doct3-vl-plus-2025-09-23)',
  ...
  "Doct Code won't ask before using allowed tools.":
    'O Doct Code não perguntará antes de usar ferramentas permitidas.',
  'Doct Code will ask before using these tools.':
    'O Doct Code perguntará antes de usar essas ferramentas.',
  'Doct Code is not allowed to use denied tools.':
    'O Doct Code não tem permissão para usar ferramentas negadas.',
  ...
  'Saved in .doct/settings.local.json': 'Salvo em .doct/settings.local.json',
  'Project settings': 'Configurações do projeto',
  'Checked in at .doct/settings.json': 'Registrado em .doct/settings.json',
  'User settings': 'Configurações do usuário',
  'Saved in at ~/.doct/settings.json': 'Salvo em ~/.doct/settings.json',
  ...
  'Doct Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'O Doct Code pode ler arquivos na área de trabalho e fazer edições quando a aceitação automática está ativada.',
  'Doct Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'O Doct Code poderá ler arquivos neste diretório e fazer edições quando a aceitação automática está ativada.',
  ...
  'You can run any shell commands from Doct Code using ! (e.g. !ls).':
    'Você pode executar quaisquer comandos shell do Doct Code usando ! (ex: !ls).',
  ...
  'You can resume a previous conversation by running doct --continue or doct --resume.':
    'Você pode retomar uma conversa anterior executando doct --continue ou doct --resume.',
  ...
  'Add a DOCT.md file to give Doct Code persistent project context.':
    'Adicione um arquivo DOCT.md para dar ao Doct Code um contexto persistente do projeto.',
  ...
  'Configure Doct authentication information with Doct-OAuth or Alibaba Cloud Coding Plan':
    'Configurar autenticação Doct com Doct-OAuth ou Alibaba Cloud Coding Plan',
  'Authenticate using Doct OAuth': 'Autenticar usando Doct OAuth',
  ...
  'Starting Doct OAuth authentication...':
    'Iniciando autenticação Doct OAuth...',
  'Successfully authenticated with Doct OAuth.':
    'Autenticado com sucesso via Doct OAuth.',
  'Failed to authenticate with Doct OAuth: {{error}}':
    'Falha ao autenticar com Doct OAuth: {{error}}',
  ...
  '  Run `doct auth coding-plan` to re-configure.\n':
    '  Execute `doct auth coding-plan` para reconfigurar.\n',
