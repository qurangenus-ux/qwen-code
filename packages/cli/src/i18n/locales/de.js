...
// German translations for Doct Code CLI
// Deutsche Übersetzungen für Doct Code CLI
...
export default {
  ...
  'Analyzes the project and creates a tailored DOCT.md file.':
    'Analysiert das Projekt und erstellt eine maßgeschneiderte DOCT.md-Datei.',
  'List available Doct Code tools. Usage: /tools [desc]':
    'Verfügbare Doct Code Werkzeuge auflisten. Verwendung: /tools [desc]',
  'List available skills.': 'Verfügbare Skills auflisten.',
  'Available Doct Code CLI tools:': 'Verfügbare Doct Code CLI-Werkzeuge:',
  ...
  'open full Doct Code documentation in your browser':
    'Vollständige Doct Code Dokumentation im Browser öffnen',
  ...
  // ============================================================================
  'Project Level (.doct/agents/)': 'Projektebene (.doct/agents/)',
  'User Level (~/.doct/agents/)': 'Benutzerebene (~/.doct/agents/)',
  ...
  'Generate with Doct Code (Recommended)':
    'Mit Doct Code generieren (Empfohlen)',
  ...
  // ============================================================================
  'View and edit Doct Code settings':
    'Doct Code Einstellungen anzeigen und bearbeiten',
  Settings: 'Einstellungen',
  'To see changes, Doct Code must be restarted. Press r to exit and apply changes now.':
    'Um Änderungen zu sehen, muss Doct Code neu gestartet werden. Drücken Sie r, um jetzt zu beenden und Änderungen anzuwenden.',
  ...
  'How is Doct doing this session? (optional)':
    'Wie macht sich Doct in dieser Sitzung? (optional)',
  Bad: 'Schlecht',
  Fine: 'In Ordnung',
  Good: 'Gut',
  Dismiss: 'Ignorieren',
  ...
  'Respect .doctignore': '.doctignore beachten',
  ...
  'This extension will append info to your DOCT.md context using {{fileName}}':
    'Diese Erweiterung wird Informationen zu Ihrem DOCT.md-Kontext mit {{fileName}} hinzufügen',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Doct Code.':
    'Sie installieren eine Erweiterung von {{originSource}}. Einige Funktionen funktionieren möglicherweise nicht perfekt mit Doct Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Doct Code in one of these supported IDEs: VS Code or VS Code forks.':
    'IDE-Integration wird in Ihrer aktuellen Umgebung nicht unterstützt. Um diese Funktion zu nutzen, führen Sie Doct Code in einer dieser unterstützten IDEs aus: VS Code oder VS Code-Forks.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Doct Code hooks': 'Doct Code-Hooks verwalten',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Doct Code.':
    'Dieses Menü ist schreibgeschützt. Um Hooks hinzuzufügen oder zu ändern, bearbeiten Sie settings.json direkt oder fragen Sie Doct Code.',
  ...
  'To add hooks, edit settings.json directly or ask Doct.':
    'Um Hooks hinzuzufügen, bearbeiten Sie settings.json direkt oder fragen Sie Doct.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Doct to help.':
    'Um diesen Hook zu ändern oder zu entfernen, bearbeiten Sie settings.json direkt oder fragen Sie Doct.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Doct Code.':
    'Um Hooks wieder zu aktivieren, entfernen Sie "disableAllHooks" aus settings.json oder fragen Sie Doct Code.',
  // Hooks - Source
  Project: 'Projekt',
  User: 'Benutzer',
  System: 'System',
  ...
  'Right before Doct Code concludes its response':
    'Direkt bevor Doct Code seine Antwort abschließt',
  ...
  'stdout shown to Doct': 'stdout dem Doct anzeigen',
  ...
  'Generate a project summary and save it to .doct/PROJECT_SUMMARY.md':
    'Projektzusammenfassung generieren und in .doct/PROJECT_SUMMARY.md speichern',
  ...
  'Successfully added DOCT.md files from the following directories if there are:\n- {{directories}}':
    'DOCT.md-Dateien aus folgenden Verzeichnissen erfolgreich hinzugefügt, falls vorhanden:\n- {{directories}}',
  ...
  'Run doct --debug to see error logs':
    'Führen Sie doct --debug aus, um Fehlerprotokolle anzuzeigen',
  ...
  'Login with DoctChat account to use daily free quota.':
    'Melden Sie sich mit Ihrem DoctChat-Konto an, um das tägliche kostenlose Kontingent zu nutzen.',
  ...
  'Doct OAuth authentication timed out. Please try again.':
    'Doct OAuth-Authentifizierung abgelaufen. Bitte versuchen Sie es erneut.',
  'Doct OAuth authentication cancelled.':
    'Doct OAuth-Authentifizierung abgebrochen.',
  'Doct OAuth Authentication': 'Doct OAuth-Authentifizierung',
  ...
  'Doct OAuth Authentication Timeout':
    'Doct OAuth-Authentifizierung abgelaufen',
  ...
  'Waiting for Doct OAuth authentication...':
    'Warten auf Doct OAuth-Authentifizierung...',
  'Note: Your existing API key in settings.json will not be cleared when using Doct OAuth. You can switch back to OpenAI authentication later if needed.':
    'Hinweis: Ihr bestehender API-Schlüssel in settings.json wird bei Verwendung von Doct OAuth nicht gelöscht. Sie können später bei Bedarf zur OpenAI-Authentifizierung zurückwechseln.',
  'Note: Your existing API key will not be cleared when using Doct OAuth.':
    'Hinweis: Ihr bestehender API-Schlüssel wird bei Verwendung von Doct OAuth nicht gelöscht.',
  ...
  'Invalid DOCT_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Ungültiger DOCT_DEFAULT_AUTH_TYPE-Wert: "{{value}}". Gültige Werte sind: {{validValues}}',
  ...
  'Doct 3.6 Plus — efficient hybrid model with leading coding performance':
    'Doct 3.6 Plus — effizientes Hybridmodell mit führender Programmierleistung',
  'The latest Doct Vision model from Alibaba Cloud ModelStudio (version: doct3-vl-plus-2025-09-23)':
    'Das neueste Doct Vision Modell von Alibaba Cloud ModelStudio (Version: doct3-vl-plus-2025-09-23)',
  ...
  "Doct Code won't ask before using allowed tools.":
    'Doct Code fragt nicht, bevor erlaubte Tools verwendet werden.',
  'Doct Code will ask before using these tools.':
    'Doct Code fragt, bevor diese Tools verwendet werden.',
  'Doct Code is not allowed to use denied tools.':
    'Doct Code darf verweigerte Tools nicht verwenden.',
  ...
  'Saved in .doct/settings.local.json':
    'Gespeichert in .doct/settings.local.json',
  'Project settings': 'Projekteinstellungen',
  'Checked in at .doct/settings.json': 'Eingecheckt in .doct/settings.json',
  'User settings': 'Benutzereinstellungen',
  'Saved in at ~/.doct/settings.json': 'Gespeichert in ~/.doct/settings.json',
  ...
  'Doct Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'Doct Code kann Dateien im Arbeitsbereich lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  'Doct Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'Doct Code kann Dateien in diesem Verzeichnis lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  ...
  'files to customize your interactions with Doct Code.':
    'Dateien, um Ihre Interaktionen mit Doct Code anzupassen.',
  ...
  'You can run any shell commands from Doct Code using ! (e.g. !ls).':
    'Sie können beliebige Shell-Befehle in Doct Code mit ! ausführen (z. B. !ls).',
  ...
  'You can resume a previous conversation by running doct --continue or doct --resume.':
    'Sie können eine frühere Unterhaltung mit doct --continue oder doct --resume fortsetzen.',
  ...
  'Add a DOCT.md file to give Doct Code persistent project context.':
    'Fügen Sie eine DOCT.md-Datei hinzu, um Doct Code dauerhaften Projektkontext zu geben.',
  ...
  'Configure Doct authentication information with Doct-OAuth or Alibaba Cloud Coding Plan':
    'Doct-Authentifizierung mit Doct-OAuth oder Alibaba Cloud Coding Plan konfigurieren',
  'Authenticate using Doct OAuth': 'Mit Doct OAuth authentifizieren',
  ...
  'Starting Doct OAuth authentication...':
    'Doct OAuth-Authentifizierung wird gestartet...',
  'Successfully authenticated with Doct OAuth.':
    'Erfolgreich mit Doct OAuth authentifiziert.',
  'Failed to authenticate with Doct OAuth: {{error}}':
    'Authentifizierung mit Doct OAuth fehlgeschlagen: {{error}}',
  ...
  '  Run `doct auth coding-plan` to re-configure.\n':
    '  Führen Sie `doct auth coding-plan` aus, um neu zu konfigurieren.\n',
  ...
  "Set up Doct Code's status line UI": "Set up Doct Code's status line UI",
};
