...
// Русский перевод для Doct Code CLI
...
export default {
  ...
  'Analyzes the project and creates a tailored DOCT.md file.':
    'Анализ проекта и создание адаптированного файла DOCT.md',
  'List available Doct Code tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов Doct Code. Использование: /tools [desc]',
  'List available skills.': 'Показать доступные навыки.',
  'Available Doct Code CLI tools:': 'Доступные инструменты Doct Code CLI:',
  ...
  'open full Doct Code documentation in your browser':
    'Открытие полной документации Doct Code в браузере',
  ...
  // ============================================================================
  'Project Level (.doct/agents/)': 'Уровень проекта (.doct/agents/)',
  'User Level (~/.doct/agents/)': 'Уровень пользователя (~/.doct/agents/)',
  ...
  'Generate with Doct Code (Recommended)':
    'Сгенерировать с помощью Doct Code (Рекомендуется)',
  ...
  // ============================================================================
  'View and edit Doct Code settings': 'Просмотр и изменение настроек Doct Code',
  Settings: 'Настройки',
  'To see changes, Doct Code must be restarted. Press r to exit and apply changes now.':
    'Для применения изменений необходимо перезапустить Doct Code. Нажмите r для выхода и применения изменений.',
  ...
  'How is Doct doing this session? (optional)':
    'Как дела у Doct в этой сессии? (необязательно)',
  Bad: 'Плохо',
  Fine: 'Нормально',
  Good: 'Хорошо',
  Dismiss: 'Отклонить',
  ...
  'Respect .doctignore': 'Учитывать .doctignore',
  ...
  'This extension will append info to your DOCT.md context using {{fileName}}':
    'Это расширение добавит информацию в ваш контекст DOCT.md с помощью {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Doct Code.':
    'Вы устанавливаете расширение от {{originSource}}. Некоторые функции могут работать не идеально с Doct Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Doct Code in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите Doct Code в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Doct Code hooks': 'Управлять хуками Doct Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Doct Code.':
    'Это меню только для чтения. Чтобы добавить или изменить хуки, отредактируйте settings.json напрямую или спросите Doct Code.',
  ...
  'To add hooks, edit settings.json directly or ask Doct.':
    'Чтобы добавить хуки, отредактируйте settings.json напрямую или спросите Doct.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Doct to help.':
    'Чтобы изменить или удалить этот хук, отредактируйте settings.json напрямую или спросите Doct.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Doct Code.':
    'Чтобы снова включить хуки, удалите "disableAllHooks" из settings.json или спросите Doct Code.',
  // Hooks - Source
  Project: 'Проект',
  User: 'Пользователь',
  System: 'Система',
  ...
  'Right before Doct Code concludes its response':
    'Непосредственно перед завершением ответа Doct Code',
  ...
  'stdout shown to Doct': 'stdout показан Doct',
  ...
  'Generate a project summary and save it to .doct/PROJECT_SUMMARY.md':
    'Сгенерировать сводку проекта и сохранить её в .doct/PROJECT_SUMMARY.md',
  ...
  'Successfully added DOCT.md files from the following directories if there are:\n- {{directories}}':
    'Успешно добавлены файлы DOCT.md из следующих директорий (если они есть):\n- {{directories}}',
  ...
  'Login with DoctChat account to use daily free quota.':
    'Войдите с помощью аккаунта DoctChat, чтобы использовать ежедневную бесплатную квоту.',
  ...
  'Doct OAuth authentication timed out. Please try again.':
    'Время ожидания авторизации Doct OAuth истекло. Пожалуйста, попробуйте снова.',
  'Doct OAuth authentication cancelled.': 'Авторизация Doct OAuth отменена.',
  'Doct OAuth Authentication': 'Авторизация Doct OAuth',
  ...
  'Doct OAuth Authentication Timeout': 'Таймаут авторизации Doct OAuth',
  ...
  'Waiting for Doct OAuth authentication...':
    'Ожидание авторизации Doct OAuth...',
  'Note: Your existing API key in settings.json will not be cleared when using Doct OAuth. You can switch back to OpenAI authentication later if needed.':
    'Примечание: Ваш существующий ключ API в settings.json не будет удален при использовании Doct OAuth. Вы можете переключиться обратно на авторизацию OpenAI позже при необходимости.',
  'Note: Your existing API key will not be cleared when using Doct OAuth.':
    'Примечание: Ваш существующий ключ API не будет удален при использовании Doct OAuth.',
  ...
  'Invalid DOCT_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Неверное значение DOCT_DEFAULT_AUTH_TYPE: "{{value}}". Допустимые значения: {{validValues}}',
  ...
  'Doct 3.6 Plus — efficient hybrid model with leading coding performance':
    'Doct 3.6 Plus — эффективная гибридная модель с лидирующей производительностью в программировании',
  'The latest Doct Vision model from Alibaba Cloud ModelStudio (version: doct3-vl-plus-2025-09-23)':
    'Последняя модель Doct Vision от Alibaba Cloud ModelStudio (версия: doct3-vl-plus-2025-09-23)',
  ...
  "Doct Code won't ask before using allowed tools.":
    'Doct Code не будет спрашивать перед использованием разрешённых инструментов.',
  'Doct Code will ask before using these tools.':
    'Doct Code спросит перед использованием этих инструментов.',
  'Doct Code is not allowed to use denied tools.':
    'Doct Code не может использовать запрещённые инструменты.',
  ...
  'Saved in .doct/settings.local.json': 'Сохранено в .doct/settings.local.json',
  'Project settings': 'Настройки проекта',
  'Checked in at .doct/settings.json': 'Зафиксировано в .doct/settings.json',
  'User settings': 'Пользовательские настройки',
  'Saved in at ~/.doct/settings.json': 'Сохранено в ~/.doct/settings.json',
  ...
  'Doct Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'Doct Code может читать файлы в рабочей области и вносить правки, когда автоприём правок включён.',
  'Doct Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'Doct Code сможет читать файлы в этом каталоге и вносить правки, когда автоприём правок включён.',
  ...
  'files to customize your interactions with Doct Code.':
    'файлы для настройки взаимодействия с Doct Code.',
  ...
  'You can run any shell commands from Doct Code using ! (e.g. !ls).':
    'Вы можете выполнять любые shell-команды в Doct Code с помощью ! (например, !ls).',
  ...
  'You can resume a previous conversation by running doct --continue or doct --resume.':
    'Вы можете продолжить предыдущий разговор, запустив doct --continue или doct --resume.',
  ...
  'Add a DOCT.md file to give Doct Code persistent project context.':
    'Добавьте файл DOCT.md, чтобы предоставить Doct Code постоянный контекст проекта.',
  ...
  'Run doct --debug to see error logs':
    'Запустите doct --debug для просмотра журналов ошибок',
  ...
  'Configure Doct authentication information with Doct-OAuth or Alibaba Cloud Coding Plan':
    'Настроить аутентификацию Doct через Doct-OAuth или Alibaba Cloud Coding Plan',
  'Authenticate using Doct OAuth': 'Аутентификация через Doct OAuth',
  ...
  'Starting Doct OAuth authentication...':
    'Запуск аутентификации Doct OAuth...',
  'Successfully authenticated with Doct OAuth.':
    'Успешная аутентификация через Doct OAuth.',
  'Failed to authenticate with Doct OAuth: {{error}}':
    'Ошибка аутентификации через Doct OAuth: {{error}}',
  ...
  '  Run `doct auth coding-plan` to re-configure.\n':
    '  Выполните `doct auth coding-plan` для повторной настройки.\n',
