...
import type { WebSearchProviderConfig } from '@doct-code/doct-code-core';
 ...
 * @param authType - Authentication type (e.g., 'doct-oauth')
...
export function buildWebSearchConfig(
  ...
  const isDoctOAuth = authType === AuthType.DOCT_OAUTH;
  ...
  // Step 2: Ensure dashscope is available for doct-oauth users
  if (isDoctOAuth) {
