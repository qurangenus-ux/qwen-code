 ...
 * This file handles the creation and maintenance of ~/.doct/output-language.md
...
const LLM_OUTPUT_LANGUAGE_MARKER_PREFIX = 'doct-code:llm-output-language:';
...
/**
 * Returns the path to the LLM output language rule file (~/.doct/output-language.md).
 */
...
function parseOutputLanguageFromContent(content: string): string | null {
  // Primary: machine-readable marker (e.g., <!-- doct-code:llm-output-language: 中文 -->)
