...
import { IdeClient } from '@doct-code/doct-code-core';
...
describe('systemInfo', () => {
  ...
  describe('getSandboxEnv', () => {
    ...
    it('should return sandbox name without prefix when stripPrefix is true', () => {
      process.env['SANDBOX'] = 'doct-code-test-sandbox';
      expect(getSandboxEnv(true)).toBe('test-sandbox');
    });

    it('should return sandbox name with prefix when stripPrefix is false', () => {
      process.env['SANDBOX'] = 'doct-code-test-sandbox';
      expect(getSandboxEnv(false)).toBe('doct-code-test-sandbox');
    });

    it('should handle doct- prefix removal', () => {
      process.env['SANDBOX'] = 'doct-custom-sandbox';
  ...
  describe('getExtendedSystemInfo', () => {
    it('should include memory usage and base URL', async () => {
      ...
      const { AuthType } = await import('@doct-code/doct-code-core');
