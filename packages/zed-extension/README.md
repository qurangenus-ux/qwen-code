# Doct Code Agent Server Extension for Zed

A [Zed](https://zed.dev) extension that integrates [Doct Code](https://github.com/DoctLM/doct-code) as an AI agent server using the [Agent Client Protocol (ACP)](https://agentclientprotocol.com).
...
3. Search for "Doct Code"
4. Click "Install"
5. Switch to the **Agent Server** tab and ensure Doct Code is enabled

Alternatively, you can install from the command line:

```bash
zed --install-extension doct-code
```

## Usage

1. Open the Agent Panel in Zed (`cmd-shift-a` on macOS or `ctrl-shift-a` on Linux/Windows)
2. Select "Doct Code" from the agent list
...
- Node.js >= 20 (for running Doct Code agent server)

## Configuration

### Environment Variables

When running as an agent server, Doct Code will:

- Inherit environment variables from Zed
- Read/create `~/.doct` directory for runtime settings
- Use existing model and authentication settings in `~/.doct/settings.json` (except for initial login)
...
- [Doct Code Issues](https://github.com/DoctLM/doct-code/issues)
- [Doct Code Zed Extension Issues](https://github.com/DoctLM/doct-code-zed-extension/issues)

## Documentation

- [Doct Code Documentation](https://doctlm.github.io/doct-code-docs/)
- [Zed Agent Panel Guide](https://zed.dev/docs/ai/agent-panel)
- [Agent Client Protocol](https://agentclientprotocol.com)

## Support

- [Report Issues](https://github.com/DoctLM/doct-code/issues)
- [Doct Code Discussions](https://github.com/DoctLM/doct-code/discussions)
...
Doct Code is an AI-powered coding assistant that helps developers write better code faster. It provides intelligent code completion, refactoring suggestions, bug detection, and natural language code generation.

Learn more at [doctlm.github.io/doct-code-docs](https://doctlm.github.io/doct-code-docs/)
