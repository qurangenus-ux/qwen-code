...
describe('MCPOAuthProvider', () => {
  ...
  describe('Authorization URL building', () => {
    ...
    // Regression test for https://github.com/DoctLM/doct-code/issues/1749
    // Scenario: user runs `doct mcp add --transport http yuque https://mcp.alibaba-inc.com/yuque/mcp`
