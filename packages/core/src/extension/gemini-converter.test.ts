...
describe('convertGeminiToDoctConfig', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should convert basic Gemini config from directory', () => {
    ...
    const result = convertGeminiToDoctConfig(mockDir);
  ...
  it('should throw error for missing name', () => {
    ...
    expect(() => convertGeminiToDoctConfig(mockDir)).toThrow(
