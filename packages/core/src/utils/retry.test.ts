...
describe('retryWithBackoff', () => {
  ...
  describe('Doct OAuth 429 error handling', () => {
    it('should retry for Doct OAuth 429 errors that are throttling-related', async () => {
    ...
    it('should throw immediately for Doct OAuth with insufficient_quota message', async () => {
      ...
      await expect(promise).rejects.toThrow(
        /Doct OAuth free tier quota exceeded/,
      );
    ...
    it('should throw immediately for Doct OAuth with free allocated quota exceeded message', async () => {
    ...
    it('should retry for Doct OAuth with throttling message', async () => {
    ...
    it('should retry for Doct OAuth with throttling error', async () => {
    ...
    it('should throw immediately for Doct OAuth with quota message', async () => {
    ...
    it('should retry normal errors for Doct OAuth (not quota-related)', async () => {
