...
import type { RumEvent } from './doct-logger/event-types.js';
...
describe('Circular Reference Integration Test', () => {
  ...
  it('should handle HttpsProxyAgent-like circular references in doct logging', () => {
    ...
    // Test that DoctLogger can handle this
