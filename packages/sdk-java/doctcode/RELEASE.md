...
This release includes updates to the Doct Code Java SDK with improved session management, enhanced transport options, and better error handling capabilities.
...
```gradle
implementation 'com.alibaba:doctcode-sdk:0.0.1-alpha'
```
...
3. **Extended API Coverage**: More comprehensive coverage of Doct Code CLI features
...
- Issue Tracker: https://github.com/DoctLM/doct-code/issues
