...
import com.alibaba.doct.code.cli.session.event.consumers.AssistantContentConsumers;
...
import com.alibaba.doct.code.cli.transport.process.ProcessTransport;
...
/**
 * Main entry point for interacting with the Doct Code CLI. Provides static methods for simple queries and session management.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class DoctCodeCli {
    private static final Logger log = LoggerFactory.getLogger(DoctCodeCli.class);

    /**
     * Sends a simple query to the Doct Code CLI and returns a list of responses.
     *
