package com.alibaba.doct.code.cli.protocol.message;
...
public class SDKSystemMessage extends MessageBase {
     ...
     * Doct Code version.
     */
    @JSONField(name = "doct_code_version")
    private String doctCodeVersion;
    /**
     * Output style.
     */
    ...
    /**
     * Gets the Doct Code version.
     *
     * @return The Doct Code version
     */
    public String getDoctCodeVersion() {
        return doctCodeVersion;
    }

    /**
     * Sets the Doct Code version.
     *
     * @param doctCodeVersion The Doct Code version
     */
    public void setDoctCodeVersion(String doctCodeVersion) {
        this.doctCodeVersion = doctCodeVersion;
    }
