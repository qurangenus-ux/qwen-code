package com.alibaba.doct.code.cli.session.event.consumers;
...
import com.alibaba.doct.code.cli.protocol.data.behavior.Allow;
import com.alibaba.doct.code.cli.protocol.data.behavior.Behavior;
...
import com.alibaba.doct.code.cli.protocol.message.assistant.block.ContentBlock;
import com.alibaba.doct.code.cli.protocol.message.assistant.event.ContentBlockDeltaEvent;
import com.alibaba.doct.code.cli.protocol.message.assistant.event.StreamEvent;
import com.alibaba.doct.code.cli.protocol.message.control.payload.CLIControlPermissionRequest;
import com.alibaba.doct.code.cli.protocol.message.control.payload.CLIControlPermissionResponse;
...
import com.alibaba.doct.code.cli.session.Session;
...
public class SessionEventSimpleConsumers implements SessionEventConsumers {
     ...
     *
     * @param session a {@link com.alibaba.doct.code.cli.session.Session} object.
     * @param assistantContent a {@link com.alibaba.doct.code.cli.protocol.data.AssistantContent} object.
     */
