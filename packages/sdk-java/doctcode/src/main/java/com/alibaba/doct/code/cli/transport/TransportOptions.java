package com.alibaba.doct.code.cli.transport;
...
public class TransportOptions implements Cloneable {
    /**
     * Path to the Doct executable.
     */
    private String pathToDoctExecutable;
    /**
    ...
    /**
     * Gets the path to the Doct executable.
     *
     * @return The path to the Doct executable
     */
    public String getPathToDoctExecutable() {
        return pathToDoctExecutable;
    }

    /**
     * Sets the path to the Doct executable.
     *
     * @param pathToDoctExecutable The path to the Doct executable
     * @return This instance for method chaining
     */
    public TransportOptions setPathToDoctExecutable(String pathToDoctExecutable) {
        this.pathToDoctExecutable = pathToDoctExecutable;
        return this;
    }
