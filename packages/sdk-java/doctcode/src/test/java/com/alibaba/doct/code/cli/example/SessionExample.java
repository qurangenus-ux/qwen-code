package com.alibaba.doct.code.cli.example;
...
import com.alibaba.doct.code.cli.protocol.message.assistant.block.TextBlock;
...
public class SessionExample {
    ...
    public static void runSetModelExample(Session session) {
        try {
            ...
            Optional<Boolean> modelChangeResult = session.setModel("doct3-coder-flash");
            ...
            Optional<Boolean> modelChangeResult2 = session.setModel("doct3-coder-plus");
