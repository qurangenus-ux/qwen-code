...
async function main() {
  ...
  const webviewCtx = await esbuild.context({
    ...
    // @doct-code/doct-code-core is a peer dependency of @doct-code/webui.
    // Since @doct-code/webui marks it as external in its own Vite build, the
    ...
    // '@doct-code/doct-code-core/src/core/tokenLimits.js') are also excluded;
    ...
    external: ['@doct-code/doct-code-core', '@doct-code/doct-code-core/*'],
    logLevel: 'silent',
