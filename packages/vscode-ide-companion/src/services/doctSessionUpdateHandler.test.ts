...
import type { DoctAgentCallbacks } from '../types/chatTypes.js';

describe('DoctSessionUpdateHandler', () => {
  let handler: DoctSessionUpdateHandler;
  let mockCallbacks: DoctAgentCallbacks;
  ...
  beforeEach(() => {
    ...
    handler = new DoctSessionUpdateHandler(mockCallbacks);
  });
  ...
  describe('plan handling', () => {
    ...
    it('falls back to stream chunk when onPlan is not set', () => {
      const handlerWithStream = new DoctSessionUpdateHandler({
        onStreamChunk: vi.fn(),
      });
  ...
  describe('available_commands_update handling', () => {
    ...
    it('does not call callback when onAvailableCommands is not set', () => {
      const handlerWithoutCallback = new DoctSessionUpdateHandler({});
