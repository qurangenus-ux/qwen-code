...
describe('DoctAgentManager.setModelFromUi', () => {
  it('emits the selected model metadata from the available models list', async () => {
    const manager = new DoctAgentManager();
    ...
    (
      ...
      {
        modelId: 'doct3-coder-base',
        name: 'Doct3 Coder Base',
        _meta: {
          contextLimit: 131072,
        },
      },
...
describe('DoctAgentManager.createNewSession', () => {
