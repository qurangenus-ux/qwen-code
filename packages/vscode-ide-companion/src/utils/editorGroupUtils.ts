...
/**
 * Find the editor group immediately to the left of the Doct chat webview.
 ...
 * - Uses the webview tab viewType 'mainThreadWebview-doctCode.chat'.
 */
...
/**
 * Ensure there is an editor group directly to the left of the Doct chat webview.
