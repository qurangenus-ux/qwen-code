...
> = {
  [ApprovalMode.PLAN]: {
    label: 'Plan mode',
    title: 'Doct will plan before executing. Click to switch modes.',
    iconType: 'plan',
  },
  [ApprovalMode.DEFAULT]: {
    label: 'Ask before edits',
    title: 'Doct will ask before each edit. Click to switch modes.',
    iconType: 'edit',
  },
  [ApprovalMode.AUTO_EDIT]: {
    label: 'Edit automatically',
    title: 'Doct will edit files automatically. Click to switch modes.',
    iconType: 'auto',
  },
  [ApprovalMode.YOLO]: {
    label: 'YOLO',
