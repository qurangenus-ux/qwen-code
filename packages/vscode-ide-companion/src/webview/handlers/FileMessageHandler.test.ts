...
vi.mock(
  '@doct-code/doct-code-core/src/services/fileDiscoveryService.js',
  () => ({
...
vi.mock('@doct-code/doct-code-core/src/utils/filesearch/fileSearch.js', () => ({
  FileSearchFactory: {
    create: () => fileSearchMock,
  },
}));
vi.mock('@doct-code/doct-code-core/src/utils/filesearch/crawlCache.js', () => ({
  clear: vi.fn(),
}));
