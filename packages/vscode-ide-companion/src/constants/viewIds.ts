 ...
 * `doct-code:supportsSecondarySidebar` context key in package.json.
 ...
 */
export const CHAT_VIEW_ID_SIDEBAR = 'doct-code.chatView.sidebar';
export const CHAT_VIEW_ID_SECONDARY = 'doct-code.chatView.secondary';
