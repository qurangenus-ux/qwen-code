...
export function NavToc() {
  return (
    <nav className="nav-toc">
      ...
      <a href="#section-usage">How You Use Doct Code</a>
    ...
    <>
      ...
      >
        {primarySuccess && Object.keys(primarySuccess).length > 0 && (
          <HorizontalBarChart
            data={primarySuccess}
            title="What Helped Most (Doct's Capabilities)"
            color="#3b82f6"
            allowedKeys={[
...
// Doct.md Additions Section Component
function DoctMdAdditionsSection({
  additions,
}: {
  additions: NonNullable<
    NonNullable<QualitativeData['improvements']>['Doct_md_additions']
  >;
}) {
  ...
  return (
    <div className="doct-md-section">
      <h3>Suggested DOCT.md Additions</h3>
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into Doct Code to add it to your DOCT.md.
      </p>

      <div className="doct-md-actions" style={{ marginBottom: '12px' }}>
        <button
      ...
      {additions.map((item, idx) => (
        <div key={idx} className="doct-md-item">
          <input
            type="checkbox"
  ...
  return (
    <>
      <h2
        ...
        className="text-xl font-semibold text-slate-900 mt-8 mb-4"
      >
        Existing Doct Code Features to Try
      </h2>

      {/* DOCT.md Additions */}
      {Array.isArray(improvements.Doct_md_additions) &&
        improvements.Doct_md_additions.length > 0 && (
          <DoctMdAdditionsSection additions={improvements.Doct_md_additions} />
        )}

      <p className="text-xs text-slate-500 mb-3">
        Just copy this into Doct Code and it&apos;ll set it up for you.
      </p>
      ...
      <h2
        ...
        className="text-xl font-semibold text-slate-900 mt-8 mb-4"
      >
        New Ways to Use Doct Code
      </h2>
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into Doct Code and it&apos;ll walk you through it.
      </p>
          ...
          improvements.usage_patterns.map((pat, idx) => (
            <div key={idx} className="pattern-card">
              ...
              <div className="copyable-prompt-section">
                <div className="prompt-label">Paste into Doct Code:</div>
