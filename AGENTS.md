...
This file provides guidance to Doct Code when working with code in this repository.
...
```bash
cd integration-tests && cross-env DOCT_SANDBOX=false npx vitest run cli interactive
```
