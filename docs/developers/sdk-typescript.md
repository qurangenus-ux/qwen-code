...
- Node.js >= 20.0.0
- [Doct Code](https://github.com/DoctLM/doct-code) >= 0.4.0 (stable) installed and accessible in PATH

> **Note for nvm users**: If you use nvm to manage Node.js versions, the SDK may not be able to auto-detect the Doct Code executable. You should explicitly set the `pathToDoctExecutable` option to the full path of the `doct` binary.
