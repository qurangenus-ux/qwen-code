...
| Building Open Capabilities      | ✅ Custom Commands                                                                                                                                                                 | ✅ DoctCode SDK<br>✅ Extension System                                                                                                                                                  |
...
| Github Actions          | `V0.5.0`  | doct-code-action and automation                         | Integrating Community Ecosystem | 1     |
| VSCode Plugin           | `V0.5.0`  | VSCode extension plugin                                 | Integrating Community Ecosystem | 1     |
| DoctCode SDK            | `V0.4.0`  | Open SDK for third-party integration                    | Building Open Capabilities      | 1     |
...
| Tool: TextSearch        | `V0.0.8+` | Text search tool (grep, supports .doctignore)           | Coding Workflow                 | 1     |
...
| OAuth                   | `V0.0.5+` | OAuth login authentication (Doct OAuth)                 | User Experience                 | 1     |
