...
<dependency>
    ...
    <artifactId>doctcode-sdk</artifactId>
...
```gradle
implementation 'com.alibaba:doctcode-sdk:{$version}'
```
...
The simplest way to use the SDK is through the `DoctCodeCli.simpleQuery()` method:
...
public static void runTransportOptionsExample() {
    ...
    List<String> result = DoctCodeCli.simpleQuery("who are you, what are your capabilities?", options);
    result.forEach(logger::info);
}
```
...
public static void runStreamingExample() {
    DoctCodeCli.simpleQuery("who are you, what are your capabilities?",
...
other examples see src/test/java/com/alibaba/doct/code/cli/example
...
A: yes, requires Doct CLI 0.5.5 or higher.
