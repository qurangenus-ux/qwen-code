...
<head>
  ...
  <title>Doct Code Chat Export</title>
  ...
  <script src="https://unpkg.com/@doct-code/webui@0.1.0-beta.4/dist/index.umd.js"></script>

  <!-- Load the CSS -->
  <link rel="stylesheet" href="https://unpkg.com/@doct-code/webui@0.1.0-beta.4/dist/styles.css">
...
<body>
  <div class="page-wrapper">
    <div class="header">
      <div class="header-left">
        ...
        <div class="logo">
          <div class="logo-text" data-text="DOCT">
            <span class="logo-text-inner">DOCT</span>
          </div>
        </div>
      </div>
      <div class="meta">
  ...
  <script>
    ...
    const { ChatViewer, PlatformProvider } = DoctCodeWebUI;
