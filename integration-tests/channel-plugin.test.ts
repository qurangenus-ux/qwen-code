 ...
 *
 * Tests the actual MockPluginChannel (from @doct-code/channel-plugin-example) connected
 ...
 *           → doct-code --acp (REAL model request)
...
describe('Channel Plugin (Mock WebSocket E2E)', () => {
  ...
  const setup = async () => {
    ...
    // 2. Start AcpBridge (spawns real doct-code --acp)
